...
<head>
  ...
  <title>Information for CSE Department</title>
      ...
      <div class="nav-menu">
        <div class="nav-option">
          ...
          <div class="dropdown-container">
              <div class="dropdown">
                  <a href="#" class="dropdown-header">CSE</a>
...
$query = "SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`, `session`,`profile pic` FROM cse";
                ...
                <div class='profile'>
                    ...
                    <div class='all-name'>
                        ...
                        <div class='view-more-btn'>
                            <a href='profile_for_cse.php?id=" . htmlspecialchars($student['student id']) . "'>View Profile</a>
                        </div>
                    </div>
                </div>";
            }
...
//--searching algorithm---
  ...
  if (isset($_POST["search"])) {
      ...
      $stmt = $conn->prepare("SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`FROM `cse`WHERE `full name` LIKE ?");
      if ($stmt) {
