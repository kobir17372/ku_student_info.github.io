...
<head>
    ...
    <title>Form for Math English</title>
</head>
...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO `english` (`full name`, `father name`, `mother name`, `par add`, `pre add`, `date of birth`, `mobile`, `email`, `religion`, `blood group`, `interested in`, `expert on`, `about yourself`, `institution name`, `board`, `group`, `passing year`, `institution name2`, `board2`, `group2`, `passing year2`, `institution name3`, `faculty`, `student id`, `session`)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";    
...
?>
    ...
    <div class="container3">
        <div class="image-bg">
            <div class="container">
                <form id="form" method="post" action="http://localhost/bsmru_student_information/form_eng.php">
                    <div class="form">
