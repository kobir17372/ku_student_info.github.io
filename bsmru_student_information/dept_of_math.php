...
<head>
  ...
  <title>Information for Mathematics Department</title>
      ...
      <div class="nav-menu">
        <div class="nav-option">
          ...
          <div class="dropdown-container">
              <div class="dropdown">
                  <a href="#" class="dropdown-header">Mathematics</a>
                  <div class="dropdown-menu">
                      <a href="http://localhost/bsmru_student_information/dept_of_cse.php">CSE</a>
                      <a href="http://localhost/bsmru_student_information/dept_of_english.php">ENG</a>
...
$query = "SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`, `session`,`profile pic` FROM math";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        foreach ($batches as $batch => $students) {
            ...
            foreach ($students as $student) {
              $profilePic = !empty($student['profile pic']) ? "uploads/" . htmlspecialchars($student['profile pic']) : "uploads/Default_fpf.jpg";
                echo "
                <div class='profile'>
                    ...
                    <div class='all-name'>
                        ...
                        <div class='view-more-btn'>
                            <a href='profile_for_math.php?id=" . htmlspecialchars($student['student id']) . "'>View Profile</a>
                        </div>
                    </div>
                </div>";
            }
...
//--searching algorithm---
  ...
  if (isset($_POST["search"])) {
      ...
      $stmt = $conn->prepare("SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`FROM `math`WHERE `full name` LIKE ?");
      if ($stmt) {
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  <div class='profile'>
                      ...
                      <div class='all-name'>
                          ...
                          <div class='view-more-btn'>
                              <a href='profile_for_math.php?id=" . htmlspecialchars($row['student id']) . "'>View Profile</a>
                          </div>
                      </div>
                  </div>";
              }
