...
if (isset($_POST["search"])) {
    ...
    $stmt = $conn->prepare("SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`
                            FROM `english`
...
<script>
  function searchStudent() {
    ...
    xhr.open("POST", "search_eng_dept.php", true); // Send the search query to a separate PHP script
