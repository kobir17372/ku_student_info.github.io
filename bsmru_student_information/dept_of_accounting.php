...
<head>
  ...
  <title>Information for Accounting Department</title>
      ...
      <div class="nav-menu">
        <div class="nav-option">
          ...
          <div class="dropdown-container">
              <div class="dropdown">
                  <a href="#" class="dropdown-header">Accounting</a>
...
$query = "SELECT `student id`, `full name`, `mother name`, `father name`, `par add`, `pre add`, `session`,`profile pic` FROM accounting";
                ...
                <div class='profile'>
                    ...
                    <div class='all-name'>
                        ...
                        <div class='view-more-btn'>
                            <a href='profile_for_acc.php?id=" . htmlspecialchars($student['student id']) . "'>View Profile</a>
                        </div>
                    </div>
                </div>";
            }
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  <div class='profile'>
                      ...
                      <div class='all-name'>
                          ...
                          <div class='view-more-btn'>
                              <a href='profile_for_acc.php?id=" . htmlspecialchars($row['student id']) . "'>View Profile</a>
                          </div>
                      </div>
                  </div>";
              }
