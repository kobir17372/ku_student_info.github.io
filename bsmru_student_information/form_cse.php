...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO `cse` (`full name`, `father name`, `mother name`, `par add`, `pre add`, `date of birth`, `mobile`, `email`, `religion`, `blood group`, `interested in`, `expert on`, `about yourself`, `institution name`, `board`, `group`, `passing year`, `institution name2`, `board2`, `group2`, `passing year2`, `institution name3`, `faculty`, `student id`, `session`)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";    
